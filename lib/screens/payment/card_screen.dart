...
class _CardScreenState extends State<CardScreen> {
  ...
  Widget build(BuildContext context) {
    const frameColor = Color(0xFF4A148C); // Using the dark purple from CBE for the frame
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: [
                            // Corners
                            Positioned(top: 16, left: 16, child: _buildScannerCorner(isTop: true, isLeft: true, color: frameColor)),
                            Positioned(top: 16, right: 16, child: _buildScannerCorner(isTop: true, isLeft: false, color: frameColor)),
                            Positioned(bottom: 16, left: 16, child: _buildScannerCorner(isTop: false, isLeft: true, color: frameColor)),
                            Positioned(bottom: 16, right: 16, child: _buildScannerCorner(isTop: false, isLeft: false, color: frameColor)),
                            ...
                            Center(
                              child: Icon(
                                ...
                                size: 100,
                                color: const Color(0xFFFF9800), // Orange color matching design
                              ),
                            ),
                          ],
                        ),
